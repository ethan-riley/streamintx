...
const (
	gitRepo     = "https://github.com/bluenviron/streamintx"
	downloadURL = "https://github.com/bluenviron/streamintx/releases/download/%s/streamintx_%s_%s_%s.%s"
	executable  = "streamintx"
)
...
func upgrade() error {
	...
	fmt.Printf("StreaminTX upgraded successfully from %v to %v.\n", "v"+current.String(), "v"+latest.String())
	return nil
}
